...
<br>
<img src="images/lecture-12/data_dictionary.png" width="120%"> 
...
<img src="images/lecture-12/wildlife_award.png" width="100%">
...
- Format for each year is different, variables collected differ (see [learningtower](https://github.com/kevinwang09/learningtower))  `r emo::ji("x")`
