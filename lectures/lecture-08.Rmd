...
- use the ABS geographical boundaries for the 2016 census
- integrate data from different sources to make exploratory inferences
]
...
.center[
How can we visualise this better?
]
...
* We looked at mapping the 2016 census boundaries and projected a census variable (i.e. median age) with the electoral district
