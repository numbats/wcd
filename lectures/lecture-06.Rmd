...
.item[
```{r plot1_ests, echo = FALSE, warning = FALSE, fig.height = 8.3}
```
...
```{r plot1_ests, echo = FALSE, fig.align = "center", fig.height = 8}
```
]
.item[
...
* And the estimate for the overall variance uses Rubin's rules
