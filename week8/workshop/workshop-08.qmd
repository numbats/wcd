---
title: 'ETC5512: Tidying data with AI - is it any good?'
format: 
  html:
    toc: true
...
We'll be reviewing each "step" and deciding whether we prefer: \
\
(a) AI Solution I\
(b) AI Solution II\
...
We'll also be considering whether we have a preference for a solution based on code smells or personal taste.
