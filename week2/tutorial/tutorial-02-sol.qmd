...
-   Accessible (no) - As this data isn't it a machine readable format, its not in a readily accessible format. For further discussion [see link](https://www.digital.nsw.gov.au/article/say-no-to-pdfs-ok-say-maybe).
