...
The file instructions provided above download the Fannie Mae Single Home Loan data from year 2016Q1 to 2022Q3.

This data has been pre-processed for you to use in the exercises below.

Be warned the file is large so it will still take time to read in.

Read in the data and familiarise yourself with the dimension before you get started.
:::
...
c.  Draw a histogram to show the distribution of FICO Scores (`CSCORE_B`) in different years. What do you notice?
