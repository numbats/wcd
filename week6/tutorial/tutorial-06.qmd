...
```{r}
ggplot() +
   geom_sf(data = st_zm(SA1map), aes(geometry = centroid, color = Median_tot_prsnl_inc_weekly), shape = 3) + 
   geom_sf(data = st_zm(vic_map), aes(geometry = geometry), fill = "transparent", size = 1.3, color = "gray") +
