...
*There are also issues where the Labour party has slightly different party names and acronym variants for branches in different states. This means an exact matching with ALP or Labour does not work.*

*And even with a fuzzy matching there were still edge cases that needed manual handling. This meant a persn was needed!*
...
*In terms of future work, I'd also like to consider how changes in electoral boundaries impact voter demographics. This is very interesting and I'm almost certainly going to set this as the assignment question one year! Lucky ETC5512 students.*
