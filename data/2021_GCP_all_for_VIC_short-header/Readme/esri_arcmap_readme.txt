...
9. Right click on csv file in the Table of contents window, select *Data* -> *Export Data*.
...
18. Right click on file and select *Open Attribute Table*.
19. In the table that opens, select the drop down menu from *Table Options* and select *Add Field*.
