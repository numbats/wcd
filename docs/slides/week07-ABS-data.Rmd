...
* Aggregated data presents summary statistics from the *raw data*. When the only summay statistics are counts then it is generally called *frequency data*.
...
.grid[
.item[
* Parliament of Australia comprsises two houses: 
...
* Senate uses the single tranferable voting system
