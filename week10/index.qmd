...
For assignment 4 I will ask you to think about writing your own open data case study. You will build upon the case studies we have done in case, but you may want to supplement your analysis with data you web scrape or other existing open data sets.
...
4. Even in projects that are fun there are aspects of data ethics to consider!
