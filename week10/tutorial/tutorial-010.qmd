...
The [following tutorial](https://github.com/cynthiahqy/workshop-llm-hackathon/blob/main/slides-1-monash.pdf) was given at Monash by Hadley Wickham in 2025. It showcases further how we can use LLMs in R and extends on the demo you saw in class.
