...
a. Read the survey data into R and use your exploratory data tools to explore the data. 
...
d. Now consider the second dataset. As participants were leaving the trial, they were asked if they would consider giving blood to save lives. All said yes. As part of a promotion run by the center, blood donors were asked if they would consider giving their age and name to be published on the website to encourage others to give blood. All consented and data was uploaded in real time (which is represented by date and time in the dataset). Read in the second data set and explore. 

```{r}
blood_donation <- read.csv(here::here("data/blood_donation.csv"))
```
