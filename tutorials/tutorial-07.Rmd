...
1. **Set up your project folder**
   ...
   * Create folders called `data` and `analysis` in the project root directory.

   
   * Create an `exercise.Rmd` under the `analysis` folder.
   
   * Create a README.md file in the project root directory. The easiest way to do this is to run the R command `usethis::use_readme_md()` from your project. Your README.md should explain the main purpose of the project.
