...
**Everything needed to complete the tutorial was in the** [tutorial-03.zip](https://wcd.numbat.space/tutorials/tutorial-03.zip) **on Moodle. Here are some of the things you will find when running the code.**
