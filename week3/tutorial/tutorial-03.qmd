...
The goal of today is to create your own insights using from the US Airline Traffic data.
...
Install the below packages for this week.
...
Explore your data! These tasks should be done using the dplyr interface, so that the **tidy wrangling verbs** can be used. (These are similar to SQL functions.) 

To get you started there is data ready for you to use in the data folder.
