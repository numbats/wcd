---
title: 'ETC5512: Introduction to Data Collection'
format: 
  html:
    toc: true
...
**Work** through the following [startR modules](https://startr.numbat.space/) on Tidy Data Analysis:

-   [Reading data from files](https://startr.numbat.space/modules/analysis/readr/)

-   [Tidy data and restructuring](https://startr.numbat.space/modules/analysis/tidyr/)

- [Data manipulation](https://startr.numbat.space/modules/analysis/dplyr/)
